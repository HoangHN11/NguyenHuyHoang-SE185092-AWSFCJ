...
![Các VPC Endpoint cho S3 & SSM](/images/5-Workshop/5.4-Building-the-Private-Analytics-Layer/aws-vpc-endpoints-s3-ssm.png)
...
![EventBridge rule](/images/5-Workshop/5.4-Building-the-Private-Analytics-Layer/aws-eventbridge-sbw-etl-hourly-rule.png)
